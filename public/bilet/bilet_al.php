...
.back-link {display:inline-flex;align-items:center;gap:0.5rem;color:rgba(255,255,255,0.6);text-decoration:none;font-weight:500;margin-bottom:1.5rem;padding:0.625rem 1.25rem;background:rgba(26,26,26,0.6);border-radius:10px;border:1px solid rgba(212,175,55,0.2);transition:all 0.3s ease;backdrop-filter:blur(10px);}
.back-link:hover {background:rgba(212,175,55,0.1);color:#f4d03f;border-color:rgba(212,175,55,0.4);transform:translateX(-4px);}
.back-link::before {content:'←';font-size:1.125rem;}
.payment-card {background:linear-gradient(135deg,#1a1a1a 0%,#0f0f0f 100%);border-radius:20px;box-shadow:0 8px 32px rgba(0,0,0,0.6),0 0 60px rgba(212,175,55,0.15);border:1px solid rgba(212,175,55,0.2);overflow:hidden;}
.payment-header {background:linear-gradient(135deg,rgba(212,175,55,0.2) 0%,rgba(244,208,63,0.1) 100%);padding:2.5rem 2rem;border-bottom:1px solid rgba(212,175,55,0.2);position:relative;overflow:hidden;}
.payment-header::before {content:'';position:absolute;top:0;left:0;right:0;bottom:0;background:radial-gradient(circle at 50% 0%,rgba(212,175,55,0.1),transparent 70%);z-index:0;}
.payment-header h1 {font-size:1.875rem;font-weight:700;background:linear-gradient(135deg,#ffffff 0%,#d4af37 50%,#f4d03f 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;margin-bottom:0.5rem;position:relative;z-index:1;text-shadow:0 0 30px rgba(212,175,55,0.3);}
.payment-header p {color:rgba(255,255,255,0.7);position:relative;z-index:1;}
.payment-body {padding:2rem;}
.alert {padding:1rem 1.25rem;border-radius:12px;margin-bottom:1.5rem;font-size:0.9375rem;font-weight:500;backdrop-filter:blur(10px);border:1px solid;}
.alert-success {background:linear-gradient(135deg,rgba(16,185,129,0.15),rgba(5,150,105,0.1));color:#34d399;border-color:rgba(16,185,129,0.3);box-shadow:0 0 20px rgba(16,185,129,0.1);}
.alert-error {background:linear-gradient(135deg,rgba(239,68,68,0.15),rgba(220,38,38,0.1));color:#fca5a5;border-color:rgba(239,68,68,0.3);box-shadow:0 0 20px rgba(239,68,68,0.1);}
.section {margin-bottom:2rem;}
.section-title {font-size:0.8125rem;font-weight:700;color:#f4d03f;text-transform:uppercase;letter-spacing:0.05em;margin-bottom:1rem;text-shadow:0 0 10px rgba(212,175,55,0.3);}
.info-card {background:rgba(15,15,15,0.8);border:1px solid rgba(212,175,55,0.2);border-radius:12px;padding:1.5rem;backdrop-filter:blur(10px);}
.info-row {display:flex;justify-content:space-between;padding:0.875rem 0;border-bottom:1px solid rgba(212,175,55,0.1);}
.info-row:last-child {border-bottom:none;}
.info-label {color:rgba(255,255,255,0.6);font-size:0.9375rem;}
.info-value {color:#e2e8f0;font-weight:600;font-size:0.9375rem;}
.seats-grid {display:flex;gap:0.625rem;flex-wrap:wrap;margin-top:1rem;}
.seat-item {background:linear-gradient(135deg,#d4af37,#f4d03f);color:#000;padding:0.625rem 1rem;border-radius:8px;font-size:0.875rem;font-weight:600;box-shadow:0 4px 15px rgba(212,175,55,0.2);text-align:center;}
.coupon-form {display:flex;gap:0.625rem;margin-top:0.75rem;flex-wrap:wrap;}
.coupon-input {flex:1;padding:0.625rem 1rem;border-radius:12px;border:1px solid rgba(212,175,55,0.2);background:rgba(26,26,26,0.6);color:#fff;font-weight:500;transition:all 0.3s ease;}
.coupon-input:focus {outline:none;border-color:#f4d03f;box-shadow:0 0 15px rgba(212,175,55,0.3);}
.btn-coupon {padding:0.625rem 1.5rem;border:none;border-radius:12px;background:#d4af37;color:#000;font-weight:600;cursor:pointer;transition:all 0.3s ease;}
.btn-coupon:hover {background:#f4d03f;transform:translateY(-2px);box-shadow:0 4px 15px rgba(212,175,55,0.4);}
.price-summary {background:rgba(15,15,15,0.8);border-radius:12px;padding:1rem;backdrop-filter:blur(10px);}
.price-row {display:flex;justify-content:space-between;padding:0.625rem 0;border-bottom:1px solid rgba(212,175,55,0.1);}
.price-row:last-child {border-bottom:none;font-weight:700;font-size:1rem;}
.price-row.discount {color:#34d399;}
.price-row.total {color:#f4d03f;font-weight:700;}
.balance-box {margin:1.5rem 0;padding:1rem 1.25rem;background:rgba(26,26,26,0.6);border-radius:12px;border:1px solid rgba(212,175,55,0.2);text-align:center;font-weight:600;color:#f4d03f;}
.btn-payment {width:100%;padding:1rem;border:none;border-radius:12px;background:linear-gradient(135deg,#d4af37,#f4d03f);color:#000;font-weight:700;font-size:1rem;cursor:pointer;transition:all 0.3s ease;box-shadow:0 6px 25px rgba(212,175,55,0.3);}
.btn-payment:hover:not(:disabled) {transform:translateY(-2px);box-shadow:0 8px 30px rgba(212,175,55,0.5);}
.btn-payment:disabled {background:rgba(212,175,55,0.3);cursor:not-allowed;color:rgba(0,0,0,0.6);}
</style>
</head>
<body>
<div class="container">
